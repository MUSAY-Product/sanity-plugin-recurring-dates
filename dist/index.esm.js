...
const LazyTextInput = React__default.forwardRef(function LazyTextInput2(_ref4, forwardedRef) {
  ...
  const checkEvent = React__default.useCallback(event => {
  ...
  const handleBlur = React__default.useCallback(e => {
    checkEvent(e);
    if (onBlur) {
      onBlur(e);
    }
...
const DatePicker = React__default.forwardRef(function DatePicker2(props, ref) {
  ...
  const handleSelect = React__default.useCallback(nextDate => {
    onChange(nextDate);
...
const CommonDateTimeInput = React__default.forwardRef(function CommonDateTimeInput2(props, ref) {
  ...
  const handleDatePickerInputChange = React__default.useCallback(event => {
